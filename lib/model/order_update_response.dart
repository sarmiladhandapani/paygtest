class OrderUpdateResponse {
  ...
  dynamic? _orderPaymentTransactionDetail;
  String? _orderStatus;
  String? _orderType;
  ...
  dynamic? get orderPaymentTransactionDetail => _orderPaymentTransactionDetail;
  ...
  OrderUpdateResponse({
      ...
      dynamic? orderPaymentTransactionDetail, 
      String? orderStatus, 
      String? orderType, 
  ...
  OrderUpdateResponse.fromJson(dynamic json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    map['OrderPaymentTransactionDetail'] = _orderPaymentTransactionDetail;
